...
async def start_and_stop(url="ws://localhost:9002", headers={}):
    ...
    async with websockets.connect(
        ...
        # TODO: You need to figure out how to find the pathInResource!!!
        mh_record = dict(
            protocol=9,  # DataArray
        ...
        gdam_record = dict(
            dataArrays=dict(
                zero=dict(
                    uri="eml:///dataspace('demo/pss-rand')/eml20.obj_EpcExternalPartReference(49e4c1de-891c-11ee-a655-4da4d0f45a8a)",
                    # TODO: Figure out how get this path
                    pathInResource="RESQML/49e4c1de-891c-11ee-a655-4da4d0f45a8a",
                ),
            ),
        )
